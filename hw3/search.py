...
#    print(result)
#    
#    testing = [6212, 11628, 50, 11664, 2781, 1527, 6027, 2877, 4235, 3738]
#    print([scores[docIdToIndexMap[ids]] for ids in testing])
#    
#    sys.exit("debugging")
...
#maxcount = 0
#maxid = 0
#pl = getPostingList(postings_file, dic['america'])
#h = pl.getHead()
#while h != None:
